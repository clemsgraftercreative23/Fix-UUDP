          ...
          <div class="card">
              <div class="card-body">
                ...
                <div class="col-12"><p class="card-title clr-green" >Dashboard</p></div>
                  <div class="col-6">
                  <h2 class="card-title clr-green">Master Sub Kas & Setara Kas</h2>
                  </div> 
...
<div class="py-3"></div>
                  <table id="zero-conf " class="display table table-responsive" style="width:100%">
                      <thead>
                          <tr>
                              <th >No</th>
                              <th >Kode Perkiraan</th>
                              <th >Nama </th>
                              <th >Kode Sub Perkiraan</th>
                              <th >Nama Sub</th>
                          </tr>
                      </thead>
                      <tbody>
