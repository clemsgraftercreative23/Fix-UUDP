      ...
      <div class="modal-dialog modal-xl">
          <div class="modal-content">
              ...
              <div class="row my-3"> 
                  ...
                  <div class="col-md-3">
                    <div class="form-group">
                     <label for="exampleFormControlInput1">Inquiry Date</label>
                  ...
                  <tbody>
                    <tr v-for="(item,i) in reimburses">
                      <td>@{{i + 1}}</td>
                          ...
                          <td>
                            <input type="text" class="form-control amount-other" @keyup="calculate(i, item)"  name="others[]" v-model="item.other" placeholder="Other">
                          </td>
                          <td>
