...
@php
  $showApprovalTab = in_array(auth()->user()->jabatan, ['Owner', 'Finance', 'HR GA', 'Finance Supervisor', 'Finance Manager', 'Direktur Operasional', 'superadmin'], true) || (int) $check_approval > 0;
@endphp
@if($showApprovalTab)
<div class="clearfix">
