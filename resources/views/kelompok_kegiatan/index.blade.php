          ...
          <div class="card">
              <div class="card-body">
                ...
                <div class="col-12"><p class="card-title clr-green">Dashboard</p></div>
                  <div class="col-6"> 
                    <h2 class="card-title clr-green"  >Master Kelompok Kegiatan</h2>
                  </div> 
                  <div class="col-6 text-right">
                      <form id="syncForm">
                        @csrf
                        <button type="submit" id="syncButton" class="btn btn-primary btn-sm"><i class="fas fa-sync"></i> <span class="d-none d-sm-inline">Sinkronisasi</span><span class="d-sm-none">Sync</span> Data</button>
                      </form>
                  </div>
                </div>
                <div class="py-3"></div>
                  <table id="zero-conf" class="display table-responsive-sm"  >
                      <thead>
                          <tr>
                              <th >No</th>
                              <th >Kode</th>
