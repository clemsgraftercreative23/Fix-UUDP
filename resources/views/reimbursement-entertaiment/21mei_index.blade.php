      ...
      <div class="modal-dialog modal-xxl" style="max-width: 100%;margin: 19;top: 19;bottom: 19;left: 19;right: 19;display: flex;">
          <div class="modal-content">
              ...
              <div class="d-flex justify-content-between w-100">
                    <h2 class="modal-title maintitle clr-green mb-0" id="exampleModalCenterTitle">Buat Reimbursement Entertainment</h2>
            ...
            align=center width="1400">
                  ...
                  <tbody>
                    <tr class="fieldGroup">
                          ...
                          <td>
                            <input type="text" class="form-control" name="empty_zone[]" placeholder="">
                          </td>
                          <td>
                            <input type="text" class="form-control" name="attendance[]" placeholder="">
                          </td>
                          <td>
                          ...
                          <td>
                            <input type="text" class="form-control" name="guest[]" placeholder="">
                          </td>
                          <td>
                            <input type="text" class="form-control" name="guest_position[]" placeholder="">
                          </td>
                          <td>
                          ...
                          <td>
                            <input type="text" class="form-control amount-input currency amount1 change-amount" name="amount[]"  placeholder="">
                          </td>
                          <td class="file-proof">
