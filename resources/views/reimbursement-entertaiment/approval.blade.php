                ...
                <div class="row">
                  <div class="col-12">
                   ...
                   <div class="col-md-12">
                        <div class="row"> 
                            <div class="col-sm-6">
                                <h2 class="card-title clr-green">Reimbursement Entertaiment (Approval)</h2>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            <div class="btn-group" role="group" aria-label="Basic example">
                                ...
                                <button class="btn btn-primary d-block" @click="reset()" style="margin-top:32px" title="Reset"><i class="fas fa-sync-alt fa-fw"></i></button>
                                @if(auth()->user()->jabatan!='karyawan')
                  ...
                  <tbody>
                    <tr v-for="(item,i) in reimburses">
                      <td>@{{i + 1}}</td>
                          ...
                          <td>
                            <input type="text" class="form-control amount-input" :name="'details['+i+'][amount]'" @change="changeAmount(i)" v-model="item.amount" placeholder="">
                          </td>
                          ...
                          <td class="file-proof">
                            ...
                            <input type="file" accept="image/*" :name="'details['+i+'][file]'"  style="display: none; " class="file-input">
                            <input type="file" accept="image/*" :name="'details['+i+'][proof]'" capture="camera" class="camera-input" style="display: none;">
  ...
  new Vue({
      ...
      methods: {
        ...
        approve(){
          ...
          $.ajax({
            url: '{{url("/")}}/reimbursement-entertaiment/approve_multiple/'+id+'',
            methods: 'GET',
            success: function(e) {
        ...
        loadData(start = null,end = null, status= null, driver= null) {
          ...
          $('#myTable').dataTable({
            ...
            order: [],
            ajax: {
              url:'{{ url("reimbursement-entertaiment-approval") }}',
              data:{
                first:start,
                last:end,
                status:status,
