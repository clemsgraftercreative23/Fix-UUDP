                                          ...
                                          <tr>
                                            ...
                                            <td>
                                              ...
                                              <div class="input-group">
                                                        ...
                                                        <input type="number" name="nominal_termin[]" class="form-control name_termin" style="border-radius: 5px;" id="percent"  onKeyPress="if(this.value.length==3) return false;"   placeholder="100" aria-describedby="inputGroupPrepend">
