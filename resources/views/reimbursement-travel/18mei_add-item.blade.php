                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="time" class="form-control" name="start_time" value="{{$data_travel['0']->start_time}}" id="start_time">
                            </div>  
                            
                            <div class="col-md-3">
                                <label for="">Arrival</label>
                                <input type="time" class="form-control" name="end_time" value="{{$data_travel['0']->end_time}}" id="end_time">
                            </div>    
                                ...
                                <table class="table full-width" style="width: 100%;overflow-x: auto;white-space: nowrap;display:block">
                                    ...
                                    <tbody>
                                        <tr class="fieldGroupDetail">
                                            ...
                                            <td>
                                                <div id="preview_1">
                                                    <img src="{!!url('images/file_bukti/'.$travel_detail['0']->evidence.'')!!}" style="max-width: 75px;maxHeight: 75px;border: 2px solid #28a745;borderRadius:5px;marginTop: 5px;">
                                                </div>
                                            </td>
                                            <td>
                                        ...
                                        <tr class="fieldGroupDetail">
                                            ...
                                            <td>
                                                <div id="preview_{{$n}}">
                                                    <img src="{!!url('images/file_bukti/'.$row->evidence.'')!!}" style="max-width: 75px;maxHeight: 75px;border: 2px solid #28a745;borderRadius:5px;marginTop: 5px;">
                                                </div>
                                            </td>
                                            <td>
                        ...
                        <div class="button-container">
                            <a class="btn btn-secondary text-right" href="{!!url('reimbursement-travel/'.Request::segment(3).'')!!}"><i class="fa fa-back"></i> BACK</a>&nbsp;
                            @if($data['0']->status==0)
                          		<button class="btn btn-warning" type="submit" id="action_button" name="save">UPDATE</button>&nbsp;
                            @endif
                            @if($data['0']->status==9)
                            	<button class="btn btn-warning" type="submit" id="action_button" name="save">UPDATE</button>&nbsp;
                                <button class="btn btn-primary" type="submit" id="action_button_submit" name="save_again">SUBMIT AGAIN</button>
                            @endif
                ...
                .then(function (stream) {
                    ...
                    $("#captureButton").off("click").on("click", function () {
                        ...
                        canvas.toBlob(function (blob) {
                            ...
                            let previewDiv = row.find("#preview_" + (idx + 1)); // Gunakan ID sesuai baris
