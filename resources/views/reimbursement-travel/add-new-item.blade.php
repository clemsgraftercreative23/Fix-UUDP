                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" class="form-control number-format allowance change-rate currency" name="allowance" readonly required>
                            </div>  
                            <div class="col-md-3">
...
$(document).ready(function(){
     ...
     * properly formatted string (matching THIS field's own opts, e.g.
     * amount's `thousands: ''` here differs from the other rows) before
     * masking, so it's idempotent.
     */
    ...
    function recalculateAllowanceFromTripType($scope) {
        ...
        if (!id) {
            $scope.find('.allowance').val(numberWithCommas(0));
            total_nominal();
            return;
        }
        $.ajax({
            ...
            success: function (data) {
                ...
                $scope.find('.allowance').val(numberWithCommas(allowanceInIDR));
                total_nominal();
            }
        });
    }
    ...
    $(document).on('change', '#rt-travel-item-pane #trip_type_id', function () {
        recalculateAllowanceFromTripType($(this).closest('#rt-travel-item-pane'));
    });
    ...
    // Upload multi-attachment: public/js/reimbursement-travel-upload.js
