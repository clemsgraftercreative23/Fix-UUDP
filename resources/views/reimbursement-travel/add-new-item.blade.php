                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" class="form-control number-format allowance change-rate currency" name="reimburse[0][allowance]" readonly required>
                            </div>  
                            <div class="col-md-3">
    ...
    $(document).on('focus', '.currency-select', function () {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                // Add form currencies if not already in options
            ...
            error: function(xhr) {
                console.error('Error loading currency options:', xhr);
            }
        });
    });
