...
class PertanggungjawabanuudpController extends Controller
{
    ...
    public function insertPertanggungjawaban($id) {
        ...
        if ($cek_view==0) {
            return view('pertanggungjawaban.addPertanggungjawaban',['pengajuan'=>$pengajuan,'data'=>$pengajuandt,'list_pengajuan'=>$list_pengajuan,'departemen'=>$departemen,'kasbank'=>$kasbank,'count_status'=>$count_status,'dana_dilaporkan'=>$dana_dilaporkan,'id_pengajuan'=>$id_pengajuan,'username'=>$username,'no_project'=>$no_project]);
        } else {
            ...
            return view('pertanggungjawaban.finishPertanggungjawaban',[
                ...
                'id_pengajuan'=>$id_pengajuan,'pj'=>$pj,'finish'=>$finish]);
        }
