...
class UseraplikasiController extends Controller
{
    ...
    {
        $user = DB::select( DB::raw("SELECT * FROM users WHERE jabatan='superadmin' OR jabatan='Owner' OR jabatan='Finance' OR jabatan='Direktur Operasional'  OR jabatan='Direktur Utama'" ));  
    ...
    public function add_user()
    {
        ...
        return view('user/add_user',['user'=>$user]);
    }
    ...
    public function edit_useraplikasi($id)
    {
        ...
        $user = DB::select( DB::raw("SELECT * FROM users" ));  
        return view('user/edit_user',['user'=>$user,'us'=>$us]);
    }
